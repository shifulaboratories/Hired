...
title: "Me tools"
sidebarTitle: "Me"
description: "Thirty-one tools over roles, backgrounds, highlights, notes, standing rules, the four supporting collections, and importing a resume you already have."
icon: "user"
---
...
| `heading` | string | Optional markdown H2 heading to file it under, e.g. 'Q3 platform migration'. Merges into an existing section of the same name. 'Rules' and 'Caveats' are reserved — see the description. |
