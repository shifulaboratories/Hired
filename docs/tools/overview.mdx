...
| **What `tools/list` returns** | **157** | **190** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Letters" icon="envelope-open-text" href="/tools/letters">
    6 tools · everything you write that is not a resume: cover letters, cold outreach, referral asks, thank-yous, replies.
  </Card>
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    57 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
  ...
  <Card title="Your account" icon="plug" href="/tools/connections">
    14 tools · who you are, the two emails this app can send you, the wiring itself, and getting all of it back out again.
  </Card>
...
That is 180. The remaining 10 are the [workflows](/workflows), which are
