...
| **What `tools/list` returns** | **147** | **180** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    53 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
...
That is 170. The remaining 10 are the [workflows](/workflows), which are
