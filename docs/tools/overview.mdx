...
| **What `tools/list` returns** | **125** | **157** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  <Card title="Me" icon="user" href="/tools/me">
    24 tools · roles, backgrounds, highlights, notes, standing rules, the four supporting collections, and importing an existing resume.
  </Card>
  <Card title="Resumes" icon="file-lines" href="/tools/resumes">
    17 tools · writing documents, previewing them, publishing, exporting.
  </Card>
  ...
  <Card title="Admin" icon="shield-halved" href="/tools/admin">
    31 tools · accounts, invitations, the waitlist, sign-in, email, billing, health, configuration.
  </Card>
</CardGroup>

That is 148. The remaining 9 are the [workflows](/workflows), which are
...
<AccordionGroup>
  <Accordion title="Read first, write back whole" icon="pen-to-square">
    ...
    `append_role_background` is the additive counterpart, and it is the right call
