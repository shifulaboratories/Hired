...
| **What `tools/list` returns** | **121** | **151** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Resumes" icon="file-lines" href="/tools/resumes">
    15 tools · writing documents, previewing them, publishing, exporting.
  </Card>
  ...
  <Card title="Gmail & Calendar" icon="envelope" href="/tools/google">
    6 tools · the threads and meetings behind any record, read live from your own Google account.
  </Card>
...
That is 142. The remaining 9 are the [workflows](/workflows), which are
