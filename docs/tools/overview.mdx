...
| **What `tools/list` returns** | **227** | **262** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  <Card title="Me" icon="user" href="/tools/me">
    39 tools · roles, backgrounds, highlights, notes, standing rules, the four supporting collections, and importing an existing resume.
  </Card>
...
That is 252. The remaining 10 are the [workflows](/workflows), which are
