...
| **What `tools/list` returns** | **187** | **220** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    82 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
  ...
  <Card title="Your account" icon="plug" href="/tools/connections">
    18 tools · who you are, the two emails this app can send you, the wiring itself, and getting all of it back out again.
  </Card>
...
That is 210. The remaining 10 are the [workflows](/workflows), which are
