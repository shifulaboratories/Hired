...
| **What `tools/list` returns** | **153** | **186** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Your account" icon="plug" href="/tools/connections">
    10 tools · who you are, the wiring itself, and getting all of it back out again.
  </Card>
...
That is 176. The remaining 10 are the [workflows](/workflows), which are
