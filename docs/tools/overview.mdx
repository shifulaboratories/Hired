...
| **What `tools/list` returns** | **164** | **197** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    63 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
...
That is 187. The remaining 10 are the [workflows](/workflows), which are
