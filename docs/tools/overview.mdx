...
| --- | --- | --- |
| Data tools | 191 | 223 |
| Workflows, also published as tools | 9 | 10 |
| **What `tools/list` returns** | **200** | **233** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Resumes" icon="file-lines" href="/tools/resumes">
    19 tools · writing documents, previewing them, publishing, exporting.
  </Card>
  <Card title="Letters" icon="envelope-open-text" href="/tools/letters">
    7 tools · everything you write that is not a resume: cover letters, cold outreach, referral asks, thank-yous, replies.
  </Card>
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    88 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
  ...
  <Card title="Mail & Calendar" icon="envelope" href="/tools/accounts">
    11 tools · the threads and meetings behind any record, read live from your own Google, Microsoft 365 or IMAP and CalDAV accounts.
  </Card>
  <Card title="Your account" icon="plug" href="/tools/connections">
    21 tools · who you are, the two emails this app can send you, the wiring itself, and getting all of it back out again.
  </Card>
...
That is 223. The remaining 10 are the [workflows](/workflows), which are
...
<Card title="The ten workflows" icon="list-ol" href="/workflows" horizontal>
  Multi-step plans an assistant follows: tailoring, gap reports, mining a background, the
  weekly review, company research, interview prep, writing a letter, filing your week,
  reviewing your inbox, onboarding someone.
</Card>
