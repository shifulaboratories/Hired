...
| **What `tools/list` returns** | **127** | **160** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    40 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
...
That is 151. The remaining 9 are the [workflows](/workflows), which are
