...
| **What `tools/list` returns** | **175** | **208** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    74 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
...
That is 198. The remaining 10 are the [workflows](/workflows), which are
