...
| **What `tools/list` returns** | **198** | **231** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Your account" icon="plug" href="/tools/connections">
    20 tools · who you are, the two emails this app can send you, the wiring itself, and getting all of it back out again.
  </Card>
...
That is 221. The remaining 10 are the [workflows](/workflows), which are
