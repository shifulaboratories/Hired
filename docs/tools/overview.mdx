...
| **What `tools/list` returns** | **207** | **240** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  <Card title="Me" icon="user" href="/tools/me">
    26 tools · roles, backgrounds, highlights, notes, standing rules, the four supporting collections, and importing an existing resume.
  </Card>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    92 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
  ...
  <Card title="Your account" icon="plug" href="/tools/connections">
    23 tools · who you are, the two emails this app can send you, the wiring itself, and getting all of it back out again.
  </Card>
...
That is 230. The remaining 10 are the [workflows](/workflows), which are
