...
| **What `tools/list` returns** | **214** | **249** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    99 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
  ...
  <Card title="Admin" icon="shield-halved" href="/tools/admin">
    34 tools · accounts, invitations, the waitlist, sign-in, email, billing, health, configuration.
  </Card>
</CardGroup>

That is 239. The remaining 10 are the [workflows](/workflows), which are
