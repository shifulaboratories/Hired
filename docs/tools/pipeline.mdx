...
| Argument | Type | |
| --- | --- | --- |
| `application_id` | string | Only this application's offers, oldest to newest history included |
...
| `dueInDays` | number | Days from the move to the due date. 0 is that day. Omit for no due date |
...
| `detail` | string | A line of context shown under it |
| `dueInDays` | number | Days from the move to the due date |
